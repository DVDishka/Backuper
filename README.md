...
For detailed configuration and remote storage options (**FTP/SFTP/WebDAV/Google Drive**), see [Configuration](https://github.com/DVDishka/Backuper/wiki/Configuration)
